        ...
        <div class="container mt-4 py-3 mx-auto bg-white rounded shadow-sm">
            ...
            @forelse ($posts as $post)
                    <div class="col-2 col-md-4">
                        <div class="card">
                            <img src="http://localhost:1337{{ $post['attributes']['image']['data']['0']['attributes']['formats']['thumbnail']['url'] }}" 
                                class="card-img-top" alt="">
                            <div class="card-body">
                                <h5 class="card-title">{{ $post['attributes']['title'] }}</h5>
                                <p>{{ $post['attributes']['image']['data']['0']['attributes']['formats']['thumbnail']['hash'] }}</p>
